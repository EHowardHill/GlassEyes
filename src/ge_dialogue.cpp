...
const conversation talk_177 = {
    ...
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "He's chill", "What the heck man", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    ...
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Ugh..", "So, Sebellus is", "a \"half-life\".", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
