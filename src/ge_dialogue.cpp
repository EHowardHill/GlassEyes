...
const conversation broken_avalon_00 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "You are outside", "without a jacket.", "However,", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "the wind feels", "colder than it did", "before.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "The sun will be", "setting soon.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation broken_avalon_01 = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "I think that statue", "was one of the", "oldest.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "It had been there", "for.. Hmm.. I think", "twenty years.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Are you alright?", "I'm sorry.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &broken_avalon_01_alt_01, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Yes.", "I'm glad it's gone.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation broken_avalon_01_alt_01 = {
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "You don't need to", "apologize.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Honestly,", "I'm glad it's gone.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation broken_avalon_02 = {
    {0, nullptr, EM_DEFAULT, ACT_SFX_KNOCK, "No one seems to", "be in right now.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation captive_01 = {
    {0, &sprite_items::db_ch_ginger, EM_WAT, ACT_DEFAULT, "H-HEY!", "WAKE UP!", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_JEREMY, &jeremy_lay_down, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "I-I tried to fight,", "but he was", "stronger, and-", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "I-I think he", "knocked us out and", "dragged us here!", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_WAT, ACT_DEFAULT, "We've gotta", "get out!!", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation dark_152 = {
    {0, &sprite_items::db_ch_ginger, EM_EMBARRASSED, ACT_DEFAULT, "Hey.. Friend.", "I think.. Maybe..", "We should talk.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_ANNOYED, ACT_DEFAULT, "..", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DISAPPOINTED, ACT_DEFAULT, "I'm a mueto,", "you're a human,", "and.. Well..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DISAPPOINTED, ACT_DEFAULT, "The muetos and", "the humans have", "been at war for..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DISAPPOINTED, ACT_DEFAULT, "I don't know..", "", "A long time.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_ANNOYED, ACT_DEFAULT, "You're probably", "confused as to why", "I'm so friendly.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_EMBARRASSED, ACT_DEFAULT, "I think the muetos", "in Avalon are", "probably fine.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_EMBARRASSED, ACT_DEFAULT, "This happens all", "the time. Like", "you saw in Berlin.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_LAUGH, ACT_DEFAULT, "I guess it's nice we", "found a way to leave", "without the toll.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "..", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "I'm not what I", "look like, human.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "..", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "..", "..", "..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "It's cold.", "Let's make a fire", "and then talk more.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation dark_info = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Hey.. Whenever", "you see the snow", "like this,", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "There's a good", "chance someone", "dropped something.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "Might be useful.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation dark_talk = {
    ...
    {0, nullptr, EM_SKIP, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &ginger_sit_sad, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_FIRE, &fire_on, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Hey, uh..", "Now that we're", "settled,", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "I imagine you", "probably have", "questions.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "No not really", "Yeah", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &dark_talk_alt_01, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Well.. Here goes.", "Muetos aren't what", "we might seem.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "I don't know how", "much you know", "about us, but..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Our life cycle", "goes like this,", "right?", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "We pop out of", "tunnels in the", "ground,", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Already knowing", "how to talk and", "all that,", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Then we find a", "village and live", "for a couple years,", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Until we die.", "Then they throw", "our bodies into", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "the tunnels, where", "it starts over", "again.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "\"Where do the", "bodies come from,\"", "you might ask.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "I won't ask", "Right", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &dark_talk_alt_02, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Canterbury.", "There's a man there,", "Dr. Henry Erickson.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "You might have", "heard of him", "before.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Well.. He's still", "alive. And he makes", "us. In a lab.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "But that's not even", "the worst part of it", "all.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Every mueto you", "meet.. Has the piece", "of a human soul", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "inside of them.", "Slowly killing the", "human \"donor\".", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "You know how", "all the humans in", "the city act..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Off? Lethargic.", "Distressed.", "Paranoid.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "It's because Henry", "is using evil magic", "to siphon souls", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "into these meat", "puppets. I don't", "know his goal.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "And how do I", "know all this?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "I don't care", "How?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &dark_talk_alt_03, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Because I'm one", "of only two muetos", "in the world", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Who had an", "ENTIRE human soul", "moved over.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "I was a human", "not even that", "long ago.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "I've been told my", "human body is", "in a coma.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Anyways.. I want", "to get to Canterbury", "to stop this.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "Something very,", "very wrong is", "happening.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_SFX_FIRE, "H-Hey,", "what was that??", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &ginger_sit_alert, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &anim_stand, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation dark_talk_alt_01 = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Like what?", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Who are you?", "Why are you so green", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &dark_talk_alt_04, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_LAUGH, ACT_DEFAULT, "You're not gonna", "believe this, but..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "I'm, uh..", "Princess Selari.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_EMBARRASSED, ACT_DEFAULT, "I ran away from", "home because of..", "personal reasons.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "There's someone", "I need to see in", "Canterbury.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "It's the best way", "for you to get home", "too, though, so..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "I'm not putting", "you out or anything", "like that.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_HAPPY, ACT_DEFAULT, "I'm very happy I", "bumped into you,", "I wouldn't have", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_HAPPY, ACT_DEFAULT, "been able to get", "this far without", "you.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_SFX_FIRE, "H-Hey,", "what was that??", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &ginger_sit_alert, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &anim_stand, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation dark_talk_alt_02 = {
    {0, &sprite_items::db_ch_ginger, EM_EMBARRASSED, ACT_DEFAULT, "It's uh..", "pretty gross, but..", "Well..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "All I'll say for now", "is that we come", "from Canterbury,", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "and there's a, uh..", "reason I want to go.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "It's the best way", "for you to get home", "too, though, so..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "I'm not putting", "you out or anything.", "It's serendipitous.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_SFX_FIRE, "H-Hey,", "what was that??", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &ginger_sit_alert, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &anim_stand, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation dark_talk_alt_03 = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "It's because, I'm..", "uh..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_SFX_FIRE, "H-Hey,", "what was that??", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &ginger_sit_alert, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &anim_stand, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation dark_talk_alt_04 = {
    {0, &sprite_items::db_ch_ginger, EM_LAUGH, ACT_DEFAULT, "The limes.", "You are what you", "eat and all that.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "But seriously..", "I'm a Marelon.", "We, uh..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "We're a special", "kind of mueto that", "is very rare.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "There are only", "three of us in the", "whole world.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "We're green, and..", "well.. We, uh.. Play", "a certain role", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "in the kingdom.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_SFX_FIRE, "H-Hey,", "what was that??", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &ginger_sit_alert, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &anim_stand, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation dart_04 = {
    ...
    {0, &sprite_items::db_ch_sneaker, EM_DEFAULT, ACT_DEFAULT, "YOU'LL PAY FOR", "THAT, HUMAN!", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation item_153 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "You found:", "A STICK!", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "It's a great stick,", "too.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_ITEM, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, OBJ_STICKS, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation item_155 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "This would be a", "great spot for a", "campfire.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "You still need some", "things before you", "can make one.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation item_155b = {
    {0, nullptr, EM_SKIP, ACT_SFX_FIRE, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_HAPPY, ACT_MUSIC_FADEOUT, "Ahh..", "There we go.", "Much better.", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_FIRE, &fire_on, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_PROGRESS, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, DARK_TO_DARK, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation item_156 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "You found:", "FLINT!", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "What's it doing", "out here?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_ITEM, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, OBJ_FLINT, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation item_157 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "You found:", "A STEEL!", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Completely free,", "off the ground.", "What a steel.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_ITEM, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, OBJ_STEEL, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation item_158 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "You found:", "SOME STONES!", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Stone is common.", "LIFTABLE stone,", "on the other hand..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_ITEM, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, OBJ_STONES, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation item_168_alt_01 = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "That's all it says?", "\"Don't tell her\"?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "Well that's kinda..", "weird.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation item_none = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Doesn't seem to", "be anything here.", "Sorry.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation scruffys_05 = {
    ...
    {0, &sprite_items::db_ch_sneaker, EM_DEFAULT, ACT_DEFAULT, "If you beat me,", "I'll give you 50G.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sneaker, EM_DEFAULT, ACT_DEFAULT, "If I beat YOU,", "then you DIE.", "Deal?", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    ...
    {0, nullptr, EM_SKIP, ACT_GAME, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, GAME_DARTS, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation scruffys_05b = {
    {0, &sprite_items::db_ch_sneaker, EM_DEFAULT, ACT_MUSIC_FADEOUT, "I.. I can't..", "YOU!", "GLABBER!", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sneaker, EM_DEFAULT, ACT_DEFAULT, "I'LL KILL YOU!!", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_PROGRESS, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, PIT_01, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation scruffys_06b = {
    ...
    {0, &sprite_items::db_ch_robin, EM_DEFAULT, ACT_DEFAULT, "Water.", "No water.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
...
const conversation scruffys_06b_alt_01 = {
    ...
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &scruffys_06b_alt_01, static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation sebellus_00 = {
    {0, nullptr, EM_SKIP, ACT_DEFAULT, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_SEBELLUS, &sebellus_hide, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation sebellus_01 = {
    {0, &sprite_items::db_ch_ginger, EM_WAT, ACT_DEFAULT, "S-SEBELLUS??", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_MUSIC_BORED, "Oh! Hi!!", "And there's a", "human!", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_SEBELLUS_MONSTER, &sm_stab_02, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "I swear this is not", "what it looks like.", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_SEBELLUS_MONSTER, &sm_stab_01, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Uh.. What do you", "mean?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "I have indeed", "slain this mighty", "bug.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Yeah.. What do you", "think it looks like?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_SIDE_EYE, ACT_DEFAULT, "Well, you know.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "..No I don't.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "This is Sebellus,", "he's my older", "brother.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "I'm not sure how", "he got all the way", "out here.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "How *I* got out", "here, how did YOU", "get out here?", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "They are so", "worried about you", "back home!", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "I know.", "", "", COLOR_PURPLE, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "Did, the, uh,", "human kidnap you?", "Do I need to kill-", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_WAT, ACT_DEFAULT, "NO! I-I rescued him.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "I'm.. Here of my", "own volition.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "She runs away", "all the time, this", "is normal.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_SIDE_EYE, ACT_DEFAULT, "Hey.. I saw a house", "not far from here.", "We can stay there!", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "I.. Uh.. Sebellus.", "I don't think, uh..", "I'm not going-", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "It'll be fun!", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "..I guess we're a", "party of three, now.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_MUSIC_WIND, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_SEBELLUS_MONSTER, &sm_dead, {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_CUE_SEBELLUS, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation sebellus_02 = {
    {0, &sprite_items::db_ch_sebellus, EM_SIDE_EYE, ACT_DEFAULT, "Oh.. Duh, forgot", "to tell you.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "It's very well-", "guarded, there are", "all these puzzles.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_LAUGH, ACT_DEFAULT, "See, I'm not so", "smart though..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation sign_135 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "CITY LIMITS", "AVALON VILLAGE", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "NO HUMANS", "ALLOWED", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation sign_136 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "What are you", "doing here?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Go home.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation sign_142 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "WARNING:", "Don't get stuck.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "You might want to", "be careful..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_151 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "You hear quiet", "snoring under the", "blanket.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "..", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Ginger?", "*yawn*", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &talk_151_alt_01, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Yeah?", "", "Oh, sorry.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "He, uh..", "", "smells familiar.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Ew.", "Okay then", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &talk_151_alt_02, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "I'm sorry.", "Mueto thing.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "We shouldn't wake", "him up.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_151_alt_01 = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "You're right.", "We need to find", "fire material.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_151_alt_02 = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Oh.. Yeah, sorry.", "Mueto thing.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "We shouldn't wake", "him up though.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "I don't know, I", "just have a", "gut feeling, y'know.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_168 = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Hey- What does", "the note say?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "\"EVICTION NOTICE,", "VACATE PREMISES", "IMMEDIATELY.\"", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Tell her", "Don't tell her", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &item_168_alt_01, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "That's all it says?", "\"Tell her\"?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "Well that's kinda..", "weird.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_175 = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Much to your", "surprise, it's", "full of food.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Strange.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_177 = {
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "So, uh..", "That's my brother.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "What do you", "think about him?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "He's chill", "What the heck man", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &talk_177_alt_02, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_LAUGH, ACT_DEFAULT, "Oh, whew..", "I was a bit worried.", "He's a lot.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "You probably", "noticed his.. Uh..", "His eyes.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "He has what they", "call \"Glass Eyes\".", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "He can see things", "other people", "can't.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "It was to", "compensate for..", "other things.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "I'm glad he's in", "there.. I don't want", "to talk about", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "this in front", "of him.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "\"I can hear you", "by the way!\"", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_EMBARRASSED, ACT_DEFAULT, "Crap-", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "\"It's ok I don't", "care if you talk", "about it!\"", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "No, it's fine!", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "\"Do it!\"", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "", "..Sebellus only has", "a few years left.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "He probably won't", "live to be older", "than ten.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "He doesn't take", "it very seriously.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "..", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "..", "..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "..Changing the", "subject..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_HAPPY, ACT_DEFAULT, "If you had to pick", "a flavor, which", "is better?", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_HAPPY, ACT_DEFAULT, "Butterscotch", "or Cinnamon?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Butterscotch", "Cinnamon", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &talk_177_alt_01, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_HAPPY, ACT_DEFAULT, "Alright..", "Duly noted.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "Anyways..", "That's all I have", "to say.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "I need some", "time to, uh..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Think about", "some things.", "", COLOR_PURPLE, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_177_alt_01 = {
    {0, &sprite_items::db_ch_ginger, EM_HAPPY, ACT_DEFAULT, "Aw, that's my", "favorite.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "Anyways..", "That's all I have", "to say.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "I need some", "time to, uh..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Think about", "some things.", "", COLOR_PURPLE, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_177_alt_02 = {
    {0, &sprite_items::db_ch_ginger, EM_LAUGH, ACT_DEFAULT, "Yeah..", "He's a lot.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "You probably", "noticed his.. Uh..", "His eyes.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "He has what they", "call \"Glass Eyes\".", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "He can see things", "other people", "can't.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "It was to", "compensate for..", "other things.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    ...
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "\"It's ok I don't", "care if you talk", "about it!\"", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SULLEN, ACT_DEFAULT, "No, it's fine!", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "\"Do it!\"", "", "\"I love you!\"", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "", "..Sebellus only has", "a few years left.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "He probably won't", "live to be older", "than ten.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "He doesn't take", "it very seriously.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "..", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
...
const conversation talk_177a = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Mm-hmm?", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "What now", "Nevermind", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, &talk_177a_alt_01, static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Well.. I guess", "it's probably a", "good time to", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "get some sleep.", "I still don't trust", "this place..", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "But it's better", "than outside.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "Running water and", "all that.", "Food.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Anyway, enough", "me. I'm just gonna", "sit here a moment.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_177a_alt_01 = {
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Oh.. Okay.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "*yawn*", "I'm probably gonna", "get sleep soon.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};

const conversation talk_189 = {
    {0, &sprite_items::db_ch_ginger, EM_HAPPY, ACT_DEFAULT, "Whoa.. It's so nice", "in here!", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "I'm a little", "suspicious though..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_DEFAULT, ACT_DEFAULT, "Something doesn't", "feel right.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "You can say that,", "but that couch is", "MINE.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "Very well..", "I'll check out the", "kitchen.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_LAUGH, ACT_DEFAULT, "Hehe.. She likes the", "kitchen because", "she's a girl.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_ANGRY, ACT_DEFAULT, "Sebellus!", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_SIDE_EYE, ACT_DEFAULT, "I wanted to clarify", "for human because", "I don't know if", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_SIDE_EYE, ACT_DEFAULT, "humans can tell", "boys and girls", "apart.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_sebellus, EM_DEFAULT, ACT_DEFAULT, "So, human,", "Ginger is a girl,", "by the way.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "Ughh", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_WALK, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_GINGER, &ginger_hide, {17, 6}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_WALK, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_SEBELLUS, &sebellus_hide, {6, 3}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation talk_190b = {
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Our hero", "is snoring so loud,", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "the floor is", "shaking slightly.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_DEFAULT, "Just how does", "he do it?", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
...
const conversation togore_01 = {
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Oh dear.. Hey there,", "little buddy.", "Are you hurt?", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Did the mean man", "from the tavern", "kidnap you too?", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_togore, EM_DEFAULT, ACT_DEFAULT, "My papa twayded", "me for a beer. Thso", "I'm thtuck heow.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Do you need our", "help getting you", "out?", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_togore, EM_DEFAULT, ACT_DEFAULT, "No.", "Ith okay down here.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Are you sure?", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_togore, EM_DEFAULT, ACT_DEFAULT, "Yeth.", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Well..", "Okay, then.", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SIDE_EYE, ACT_DEFAULT, "I can't stand seeing", "kids in pain like", "this.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_togore, EM_DEFAULT, ACT_DEFAULT, "Thereth juith.", "And snacks.", "And my toyths.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_togore, EM_DEFAULT, ACT_DEFAULT, "I'll standth on the", "button to let you", "guysth out.", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, &sprite_items::db_ch_ginger, EM_SAD, ACT_DEFAULT, "Okay..", "If you insist..", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_SKIP, ACT_WALK, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, CHAR_TOGORE, static_cast<const animation*>(nullptr), {8, 6}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)},
    {0, nullptr, EM_DEFAULT, ACT_END, "", "", "", 0, SIZE_DEFAULT, SP_DEFAULT, 0, static_cast<const animation*>(nullptr), {0, 0}, static_cast<const conversation*>(nullptr), static_cast<const conversation*>(nullptr)}};
